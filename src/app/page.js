...
// //   useEffect(() => {
// //        fetch('http://10.248.141.146:8000/issues')
// //       .then((res) => {
...
// // Backend Base URL
// const API_BASE_URL = 'http://10.248.141.146:8000';
...
// // Safe Helper for Image URL (Supports Backend Pydantic photo_url Schema)
// function getImageUrl(issue) {
//   if (!issue) return "https://images.unsplash.com/photo-1515162816999-a0c47dc192f7?q=80&w=600";
  
//   // Exact field matching Pydantic Model (photo_url) + Fallbacks
...
//   // Handle external absolute image links (e.g. Cloudinary, S3)
//   if (imgPath.startsWith('http://') || imgPath.startsWith('https://')) {
//     return imgPath;
//   }

//   // Handle backend relative uploaded files (/uploads/filename.jpg)
//   const cleanPath = imgPath.replace(/\\/g, '/');
//   const finalPath = cleanPath.startsWith('/') ? cleanPath : `/${cleanPath}`;
//   return `${API_BASE_URL}${finalPath}`;
// }

// // Reported By Count Calculation
...
//   // Selected Issue for Popup Modal
...
//       {/* POPUP MODAL (SHOWING TITLE, SUMMARY, REPORTED BY, STATUS, LOCATION, LANDMARK & REAL PHOTO) */}
//       {selectedIssue && (
